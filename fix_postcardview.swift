...
// 使用TimeSpaceTransitionEffect中定义的类型
// 导入的类型包括: SwipeDirection, TimeSpaceParticleView, TimeSpaceRippleView

// 此处是原始的PostCardView.swift内容，直到行2823
import SwiftUI
import Foundation
import UIKit
import Combine
...
// 使用TimeSpaceTransitionEffect中定义的SwipeDirection枚举
// 使用TimeSpaceTransitionEffect中定义的TimeSpaceParticleView和TimeSpaceRippleView结构体
// 使用FullscreenPostDetailView.swift中定义的FullscreenPostDetailView结构体
