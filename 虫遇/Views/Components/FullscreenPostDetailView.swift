                    ...
                    VStack(spacing: 0) {
                        ...
                        HStack {
                            ...
                            Text("探索虫洞深处")
                                ...
                                .shadow(color: .black.opacity(0.5), radius: 2, x: 0, y: 0) // 添加阴影提高可读性
                            Spacer()
                        }
                        .padding(.top, getSafeAreaTop() + 10)  // 与返回按钮高度精确对齐，返回按钮Y坐标为topPadding + 10
                        .padding(.bottom, 12)  // 减少底部空间
                        .background(Color.clear) // 确保背景透明，不影响布局
